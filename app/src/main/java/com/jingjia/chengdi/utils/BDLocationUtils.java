...
//            sb.append(location.getDirection());// 单位度
    ...
    public static void startBDClient(Context context, String address) {
        if (isInstallByread("com.baidu.BaiduMap")) {
            try {
                Intent intent = Intent.getIntent("intent://map/geocoder?address=" + address + "&src=thirdapp.geo.yourCompanyName.yourAppName#Intent;scheme=bdapp;package=com.baidu.BaiduMap;end");
                context.startActivity(intent);
            } catch (URISyntaxException e) {
                e.printStackTrace();
            }
        } else {
            ActivityUtils.toast(context, "您需要安装百度地图客户端！");
        }
    }
