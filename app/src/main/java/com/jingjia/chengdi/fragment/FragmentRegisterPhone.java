...
import com.jingjia.chengdi.RegisterActivity;
        ...
        bn_getCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (curPhone.length() != PHONE_COUNT) {
                    ...
                    MyApplication.registInfo.setPhone(et_Phone.getText().toString().trim());//得到当前的手机号
                }
            }
        });
    }
    ...
    private void nextToPsw(View view) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.sendEmptyMessageDelayed(0x2, 1500);//延迟判断验证状态，缓解验证结果没能及时返回
                /**
                 * 这里测试用，到时候下面要删除
                 */
                MyApplication.registInfo.setPhone(et_Phone.getText().toString().trim());//得到当前的手机号
