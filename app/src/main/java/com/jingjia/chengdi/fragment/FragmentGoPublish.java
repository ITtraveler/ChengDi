 ...
 */
public class FragmentGoPublish extends Fragment implements ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener {
    private static FragmentGoPublish fragment;
    private ViewPager viewPager;
    private FragmentManager fm;
    private MyPagerAdapter pagerAdapter;
    private RadioButton rb_goint, rb_complete;
    private FragmentGoPublishContent[] fgpcs = {new FragmentGoPublishContent(), new FragmentGoPublishContent()};

    public static FragmentGoPublish newInstance() {//单例
        if (fragment == null) {
            fragment = new FragmentGoPublish();
        }
        return fragment;
    }
    ...
    private void initStatus(View view) {
        ...
        RadioGroup rg_state = (RadioGroup) view.findViewById(R.id.go_state);
        rg_state.setOnCheckedChangeListener(this);//RadioGroup改变监听器
    }
